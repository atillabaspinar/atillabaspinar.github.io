...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.coronaApi.timeseries().subscribe(function (val) {
            console.log(val);
          });
          this.coronaApi.latest().subscribe(function (values) {
            // console.log(values);
            var countries = [];
            var valuesRef = JSON.parse(JSON.stringify(values));
            _this.lastest = values; // this.lastest = values.slice(0, 10);
            ...
            for (var i = 0; i < _this.lastest.length - 1; i++) {
              ...
              if (country) {
                ...
                _this.valueTree[0].children.push(_temp);
              }
            }

            _this.valueTree = _this.valueTree[0].children; // setTimeout(() => {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 19,
      vars: 4,
      consts: [[1, "container-fluid"], [1, "row"], [1, "col-6", "mb-2"], [1, "card"], [1, "card-header", "bg-dark", "text-light"], [1, "card-body"], [1, "card-subtitle", "mb-2"], [3, "value"], ["pTemplate", "header"], ["pTemplate", "body"], [3, "rowNode"]],
      ...
      directives: [primeng_treetable__WEBPACK_IMPORTED_MODULE_2__["TreeTable"], primeng_api__WEBPACK_IMPORTED_MODULE_3__["PrimeTemplate"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterOutlet"], primeng_treetable__WEBPACK_IMPORTED_MODULE_2__["TreeTableToggler"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\CoronaApp\corona-live\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
