...
function AppComponent_p_progressSpinner_24_Template(rf, ctx) { if (rf & 1) {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 25, vars: 8, consts: [[1, "container-fluid", "bg-dark"], [1, "row"], [1, "col-12", "mb-2"], [1, "first-row"], [1, "card"], [1, "card-header", "bg-dark", "text-light"], [1, "card-body"], [1, "card-subtitle", "mb-2"], [1, "card", "plot"], ["id", "history-plot"], ["selectionMode", "single", "dataKey", "countryregion", "scrollHeight", "600px", 3, "value", "selection", "autoLayout", "scrollable", "selectionChange", "onNodeSelect", "onNodeUnselect"], ["pTemplate", "header"], ["pTemplate", "body"], ["style", "z-index: 1;top: calc(50% - 50px);left: calc(50% - 50px);position: fixed;", "styleClass", "progress-spinner", 4, "ngIf"], [3, "ttSelectableRow"], [3, "rowNode"], ["styleClass", "progress-spinner", 2, "z-index", "1", "top", "calc(50% - 50px)", "left", "calc(50% - 50px)", "position", "fixed"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
